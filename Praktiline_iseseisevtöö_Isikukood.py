...
sugu={"1":"mees","2":"naine","3":"mees","4":"naine","5":"mees","6":"naine"}
while True:
    isikukood=input("Sisesta isikukood: ")
    if isikukood=="0":
        break
    if not isikukood.isdigits() or len(isikukood)!=11:
        print("Viga! isikukood peab olema ainult arvudest ja peab olema 11 arvu.")
